...
DATA_URL_ROOT = "https://self-driving-dataset.s3-us-west-2.amazonaws.com/Ch2_001/"
list_frame = pd.read_csv(DATA_URL_ROOT + 'final_example.csv')
...
image_url = os.path.join(DATA_URL_ROOT + 'center/', selected_frame)
